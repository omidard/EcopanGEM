...
directory = '/home/omidard/fitness_results'  # Adjust this to your actual directory
file_pattern = 'fitness_'
...
output_path = os.path.join(directory, 'master_urine_knockout.csv')
