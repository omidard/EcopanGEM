...
def calculate_knockout_fitness(args):
    ...
    if reaction_id in original_model.reactions:
        ...
        try:
            ...
            original_model.solver.configuration.timeout = 8
...
def run_simulation():
    ...
    for model_id in tqdm(model_ids, desc="Processing models"):
        ...
        output_file = os.path.join(DATA_DIR, 'fitness_results', f'serum_fitness_{model_id}.csv')
